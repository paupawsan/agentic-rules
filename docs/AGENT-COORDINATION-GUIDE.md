...
- **Agent Configuration Generator**: `setup.html` (generates `modules/cursor-agents/*.md` files)
- **Bootstrap Configuration**: `bootstrap.json`

**Note**: Agent configuration files (`modules/cursor-agents/*.md`) are auto-generated by `setup.html`. Users should generate them using the installer rather than creating them manually.
