...
>
> 🔧 **エンジニア/開発者向け**: より優れた機能を備えたPythonランチャーを使用してください - 直接ファイル作成とサーバーコントロールを提供します。セットアップ自動化オプションについては[開発者ガイド](docs/localization/ja/DEVELOPER-GUIDE.ja.md)を参照してください。
...
1. **AIエージェントに伝える**: `Agentic rules systemを初期化`
