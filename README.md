...
- **[メインページ / Main Page](docs/localization/ja/INDEX.ja.md)** - フレームワークの概要とクイックスタート
...
- **[Halaman Utama / Main Page](docs/localization/id/INDEX.id.md)** - Ikhtisar framework dan mulai cepat
