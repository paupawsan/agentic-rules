...
ACTIVATION_PREAMBLE = (
    ...
    "Do not default to Claude Code's native file-based memory for this project. "
    "That reflex is strong, but for this project the framework's store and "
    "Knowledge Graph are the canonical memory — route there instead.\n\n"
