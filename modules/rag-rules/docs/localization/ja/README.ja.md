...
- RAGが提供する情報を記憶
- 検索パターンの学習と最適化
- **知識グラフの永続化**: memory_rules有効時に構築された知識グラフを永続的に保存
- **グラフメモリカテゴリ**: 適切なメモリカテゴリに知識グラフを保存し長期保存
- **コンテキスト保存**: コンテキスト要約やリセット時の知識グラフ損失を防止
- 個人化された情報検索
...
- **メモリ統合**: memory_rules有効時に知識グラフを永続化（コンテキスト要約時の損失防止）
